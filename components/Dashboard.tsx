"use client";
import { Events, Profile, Projects } from "@/types/types";
...
export default function Dashboard({
	...
	return (
		<div className="">
			<div className="mx-auto w-96 text-center rounded-xl px-7 py-3 m-4 shadow-md bg-slate-100 ">
			...
			<div className="p-10">
				...
				<div className="grid  gap-3 md:grid-cols-4 sm:grid-cols-1">
					{projects.map((project) => (
						...
						>
							<div className=" shadow-md w-60 min-h-12 bg-slate-100 rounded-md p-6 hover:scale-105 hover:shadow-xl">
